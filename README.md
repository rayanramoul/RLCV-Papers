...
1999 :
- George K Matsopoulos, Nicolaos A Mouravliansky, Konstantinos K Delibasis, and
...
2013 :
- Tayebeh Lotfi, Lisa Tang, Shawn Andrews, and Ghassan Hamarneh. Improving prob-
...
- Paul Wohlhart and Vincent Lepetit. Learning descriptors for object recognition and
3d pose estimation. In Proceedings of the IEEE conference on computer vision and
pattern recognition, pages 3109–3118, 2015.

2016 :
- Shun Miao, Z Jane Wang, and Rui Liao. A cnn regression approach for real-time 2d/3d
...
2017 :
- Rui Liao, Shun Miao, Pierre de Tournemire, Sasa Grbic, Ali Kamen, Tommaso Mansi,
and Dorin Comaniciu. An artificial agent for robust image registration. In Thirty-First
AAAI Conference on Artificial Intelligence, 2017
- Kai Ma, Jiangping Wang, Vivek Singh, Birgi Tamersoy, Yao-Jen Chang, Andreas
...
- Julian Krebs, Tommaso Mansi, Herv´e Delingette, Li Zhang, Florin C Ghesu, Shun
...
2018 :
- Shanhui Sun, Jing Hu, Mingqing Yao, Jinrong Hu, Xiaodong Yang, Qi Song, and
...
2013 :
- Anestis Papazoglou and Vittorio Ferrari. Fast object segmentation in unconstrained
...
2015 :
-  Yushi Chen, Xing Zhao, and Xiuping Jia. Spectral–spatial classification of hyperspec-
...
- Max Jaderberg, Karen Simonyan, Andrew Zisserman, et al. Spatial transformer net-
...
2016 :
- Fanyi Xiao and Yong Jae Lee. Track and segment: An iterative unsupervised approach
...
- Farhang Sahba. Deep reinforcement learning for object segmentation in video se-
...
- Laura Leal-Taix´e, Cristian Canton-Ferrer, and Konrad Schindler. Learning by tracking:
...
- Alexander Richard and Juergen Gall. Temporal action detection using a statistical
language model. In Proceedings of the IEEE Conference on Computer Vision and
Pattern Recognition, pages 3131–3140, 2016.
- Colin Lea, Austin Reiter, Ren´e Vidal, and Gregory D Hager. Segmental spatiotempo-
...
2017 :
- Jingchun Cheng, Yi-Hsuan Tsai, Shengjin Wang, and Ming-Hsuan Yang. Segflow:
...
- Suyog Dutt Jain, Bo Xiong, and Kristen Grauman. Fusionseg: Learning to combine
...
2117–2126. IEEE, 2017.
- Dingwen Zhang, Le Yang, Deyu Meng, Dong Xu, and Junwei Han. Spftn: A self-paced
...
2017.
- Sergi Caelles, Kevis-Kokitsi Maninis, Jordi Pont-Tuset, Laura Leal-Taix´e, Daniel Cre-
...
- Varun Jampani, Raghudeep Gadde, and Peter V Gehler. Video propagation networks.
In Proceedings of the IEEE Conference on Computer Vision and Pattern Recognition,
pages 451–461, 2017
...
2663–2672, 2017.
- Colin Lea, Michael D Flynn, Rene Vidal, Austin Reiter, and Gregory D Hager. Tem-
...
- Xizhou Zhu, Yuwen Xiong, Jifeng Dai, Lu Yuan, and Yichen Wei. Deep feature flow
...
2018 :
- Daochang Liu and Tingting Jiang. Deep reinforcement learning for surgical gesture
...
- Junwei Han, Le Yang, Dingwen Zhang, Xiaojun Chang, and Xiaodan Liang. Reinforce-
...
- Vikash Goel, Jameson Weng, and Pascal Poupart. Unsupervised video object segmen-
tation for deep reinforcement learning. In Advances in Neural Information Processing
Systems, pages 5683–5694, 2018.
- Yansong Tang, Yi Tian, Jiwen Lu, Peiyang Li, and Jie Zhou. Deep progressive rein-
...
- Kaiyang Zhou, Yu Qiao, and Tao Xiang. Deep reinforcement learning for unsupervised
video summarization with diversity-representativeness reward. In Thirty-Second AAAI
Conference on Artificial Intelligence, 2018.
- Kaiyang Zhou, Tao Xiang, and Andrea Cavallaro. Video summarisation by classifica-
tion with deep reinforcement learning. arXiv preprint arXiv:1807.03089, 2018.

2020 :
- Yujiang Wang, Mingzhi Dong, Jie Shen, Yang Wu, Shiyang Cheng, and Maja Pantic.
...
6969, 2020.
- Giuseppe Vecchio, Simone Palazzo, Daniela Giordano, Francesco Rundo, and Concetto
